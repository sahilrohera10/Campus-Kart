      ...
      <div className="2xl:container 2xl:mx-auto md:py-5 lg:px-20 md:px-6 p-4">
        <div className="flex items-center justify-between">
          ...
          <div
            ...
            className="lg:w-6/12 flex flex-row items-center space-y-3.5 logoDiv"
          >
            <div
            ...
            >
              ...
              >
                ...
                <li>
                  ...
                  {/* <div class="dropdown">
                    <button class="dropbtn" style={{ fontSize: "20px" }}>
                      Catalog
                    </button>
                    <div class="dropdown-content">
                      <Link to={`${b}`}>Books</Link>
                      <Link to={`${s}`}>Stationery</Link>
                      <Link to={`${c}`}>Courses</Link>
                      <Link to={`${f}`}>Furniture</Link>
                      <Link to={`${e}`}>Electronics</Link>
                      <Link to={`${o}`}>Other</Link>
                    </div>
                  </div> */}
                </li>
                {/* <li>
