...
export default function ProductReview() {
  ...
  console.log("in product page => ", location.state.data.productName);
  const name = location.state.data.productName;
  const price = location.state.data.price;
  const description = location.state.data.description;
  const imageId = location.state.data.imgId;
  const contact = location.state.data.contactNumber;
